...
Controller::Controller(uint8_t SDCardChipSelectPin, int serialBaudRate, int buttonPin)
{
...
void Controller::initialize(uint8_t samplingUnitsAdresses[][6], int samplingUnitsNum, int RGBRedPin, int RGBGreenPin, int RGBBluePin){
